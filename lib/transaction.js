...
require("util").inherits(Transaction, require('events').EventEmitter);
...
Transaction.prototype.toString = Transaction.prototype.toJSON = function () {
  return '[object SequelizeTransaction:'+this.id+']';
};
