...
Model.prototype.toJSON = Model.prototype.toString = function () {
...
function findPolyfill() {
  var options;
  if(!_.isNaN(+arguments[1]))
    return this.findById(arguments[1], arguments[2]);
  if(arguments.length > 2) {
    options = _.reduce(arguments, function (all, arg, i) {
      if(i === 0) return all;
      return _.extend(all, arg);
    }, {}) || null;
  }else
    options = arguments[1];
  return this["_" + arguments[0]](options);
}

var polyfill = ["findAll", "findOne", "findOrCreate", "findAndCount"];
_.each(polyfill, function(key){
  Model.prototype[key] = _.partial(findPolyfill, key);
})
...
Model.prototype._findAll = function(options) {
...
* @alias find
*/
Model.prototype._findOne = function(options) {
  if (options !== undefined && !_.isPlainObject(options)) {
 ...
 */
Model.prototype._findAndCount = function(options) {
  if (options !== undefined && !_.isPlainObject(options)) {
 ...
 */
Model.prototype._findOrCreate = function(options) {
  if (!options || !options.where || arguments.length > 1) {
    throw new Error(
