...
Sequelize.prototype.query = function(sql, model, options) {
  if(model instanceof Model){
    var opt = _.extend({model: model}, options, {type:'SELECT'});
    return this._query(sql, opt);
  }else if(options == null)
    return this._query(sql, model);
  else
    return this._query(sql, options);
}

Sequelize.prototype._query = function(sql, options) {
...
Sequelize.prototype.toString = Sequelize.prototype.toJSON = function() {
