...
var QueryGenerator = {
  ...
  changeColumnQuery: function(tableName, attributes) {
    ...
    for (var attributeName in attributes) {
      ...
      if (attributes[attributeName].match(/^ENUM\(/)) {
        ...
        query = this.pgEnumRename(tableName, attributeName) + this.pgEnum(tableName, attributeName, attributes[attributeName]) + query +
  ...
  pgEnumRename: function(tableName, attr, enumNewName) {
    ...
    return 'ALTER TYPE ' + enumName + ' RENAME TO ' + enumNewName + '; ';
  },
